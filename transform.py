...
from kornia.augmentation import RandomAffine, RandomCrop, CenterCrop, RandomResizedCrop, Resize
...
class Transforms(object):
	...
	def __init__(self, augmentation=None, shift_delta=4, image_shape=(96, 96)):
		if augmentation is None:
			augmentation = ['resize', 'shift', 'intensity']
		...
		for aug in self.augmentation:
			...
			elif aug == "resize":  # TODO add by ZYS
